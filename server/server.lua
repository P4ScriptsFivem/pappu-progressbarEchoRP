...
CreateThread(function()
    if GetCurrentResourceName() ~= "pappu-progressbarEchoRP" then
...
CreateThread(function()
    while true do
        PerformHttpRequest("https://api.github.com/repos/P4ScriptsFivem/pappu-progressbarEchoRP/releases/latest", CheckVersion, "GET")
        Wait(3600000) -- 1 hour
    end
end)
...
GetRepoInformations = function()
    ...
    PerformHttpRequest("https://api.github.com/repos/P4ScriptsFivem/pappu-progressbarEchoRP/releases/latest", function(err, response, headers)
        if err == 200 then
            ...
            repoURL = "https://api.github.com/repos/P4ScriptsFivem/pappu-progressbarEchoRP/releases/latest"
        end
    end, "GET")
